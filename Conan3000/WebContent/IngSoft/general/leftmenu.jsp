<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link" href="/Conan3000/IngSoft/servicio/evento/buscarevento.jsp"><i class="icon-wrench"></i><span class="hidden-tablet"> Servicios</span></a></li>
						<li><a class="ajax-link" href="/Conan3000/IngSoft/ventas/membresia/buscarmembresia.jsp"><i class="icon-wrench"></i><span class="hidden-tablet"> Membresias</span></a></li>						
                        ...
                        <li><a class="ajax-link" href="/Conan3000/IngSoft/ventas/promociones/buscarpromocion.jsp"><i class="icon-wrench"></i><span class="hidden-tablet"> Promociones</span></a></li>
