                    ...
                    <form class="form-horizontal">
                      <fieldset>
                        ...
                        <div class="control-group">
                          ...
                          <div class="controls">
                            <textarea name="textarea" rows="3" id="textarea2" placeholder="Sala con diversos juegos de mesa."></textarea>
                          </div>
                        </div>
                        <div class="control-group">
                          <label class="control-label" for="textarea2">Características: </label>
                          <div class="controls">
                            <textarea name="textarea2" rows="3" id="textarea2" placeholder="Área: 5 metros cuadrados."></textarea>
                          </div>
                        </div>
                        <div class="form-actions">
                          <button type="submit" class="btn btn-primary">Guardar</button>
                          <button type="reset" class="btn">Cancelar</button><br/>
                        </div>
                      </fieldset>					  
                    </form>
					<span style="font-size:70%">(*) Datos Obligatorios </span>
                  </div>
                </div>
                <!--/span-->
              </div>
