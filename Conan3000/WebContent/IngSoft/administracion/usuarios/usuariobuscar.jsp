		          ...
		          <table class="table table-striped table-bordered bootstrap-datatable datatable">
		            ...
		            <tbody>
		              <tr>
		                ...
		                <td class="center"><a class="btn btn-success" href="usuarioagregar.jsp"> <i class="icon-zoom-in icon-white"></i> Ver </a> <a class="btn btn-info" href="usuariomodificar.jsp"> <i class="icon-edit icon-white"></i> Modificar </a> <a class="btn btn-danger" href="usuarioeliminar.jsp"> <i class="icon-trash icon-white"></i> Eliminar </a></td>
	                  </tr>
